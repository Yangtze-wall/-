...
public class DESUtil {
    ...
    public static String aesDecryptForFront(String encryptStr,String decryptKey) {
        if (com.baomidou.mybatisplus.core.toolkit.StringUtils.isEmpty(encryptStr) || com.baomidou.mybatisplus.core.toolkit.StringUtils.isEmpty(decryptKey)) {
            return null;
        }
        try {
    ...
    public static  String aesEncryptForFront() {
        ...
        if (com.baomidou.mybatisplus.core.toolkit.StringUtils.isEmpty(content) || StringUtils.isEmpty(encryptKey)) {
            return null;
        }
        try {
            Cipher cipher = Cipher.getInstance("AES/ECB/PKCS5Padding");
