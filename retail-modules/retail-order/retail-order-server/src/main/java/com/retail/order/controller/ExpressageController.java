...
public class ExpressageController {
    ...
    @PostMapping("/selectExpressageList")
    public Result<List<ExpressageEntity>> selectExpressageList(){
        List<ExpressageEntity> expressageEntityList=expressageService.selectExpressageList();
