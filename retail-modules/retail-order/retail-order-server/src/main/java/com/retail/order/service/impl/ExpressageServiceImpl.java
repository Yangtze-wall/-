...
public class ExpressageServiceImpl extends ServiceImpl<ExpressageMapper, ExpressageEntity> implements ExpressageService {
    ...
    @Override
    public List<ExpressageEntity> selectExpressageList() {
        List<ExpressageEntity> expressageEntityList = this.baseMapper.selectList(null);
        return expressageEntityList;
    }
}
