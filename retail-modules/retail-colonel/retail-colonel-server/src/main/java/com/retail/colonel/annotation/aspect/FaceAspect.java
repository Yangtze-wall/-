package com.retail.colonel.annotation.aspect;

import com.retail.colonel.bean.FaceVefLog;
...
public class FaceAspect {
    ...
    @AfterReturning(value = "@annotation(com.retail.colonel.annotation.FaceLog)",returning = "res")
